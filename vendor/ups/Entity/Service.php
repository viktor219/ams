...
class Service implements NodeInterface
{
	...
	//
    const S_UPSFREIGHT_LTL = '308';
    const S_UPSFREIGHT_GUARANTED_LTL = '309';
    const S_UPSFREIGHT_GUARANTED_AM_LTL = '334';
    const S_UPSSTANDARD_LTL = '349';	
    ...
    private static $serviceNames = [
        ...
        '308' => 'UPS Freight LTL',
        '309' => 'UPS Freight Guaranted LTL',
        '334' => 'UPS Freight Guaranted AM LTL',
