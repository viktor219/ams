		...
		if (!empty($data)) {
        	...
        	if($successorder === true){                        
				...
				else 
				{
                                        ...
                                        $recentActivity->pk = $model->id;
                                        $recentActivity->customer_id = $model->customer_id;
                                        $recentActivity->user_id = Yii::$app->user->id;
                                        $recentActivity->created_at = date('Y-m-d H:i:s');
                                        $recentActivity->type = array_search('Order', Recentactivity::$type);
                                        $recentActivity->itemscount = $quantity;
