							...
							<div class="col-md-6" style="padding: 0 0 3px 0">
								...
								<div class="col-md-6">
									...
									<div id="notes-group">
										...
										<textarea class="form-control"  id="orderNotes" placeholder="Add additional notes or instructions..." style="border-radius: 4px;" name="notes" rows="3" ><?php echo $model->notes;?></textarea>
									</div>
								</div>
							<div class="col-md-6">
								<div class="btn-group btn-group-justified" id="switch-shipping-detail-tab" role="group" aria-label="Shipping Details">
									 <div class="btn-group" role="group">
										<button type="button" data-switch-set="shippingdetail" data-switch-value="0" class="btn btn-primary" data-toggle="tooltip" title="Load Asset Shipping method.">Asset</button>
									 </div>
									 <div class="btn-group" role="group">
										<button type="button" data-switch-set="shippingdetail" data-switch-value="1" class="btn btn-primary <?php if(!$model->isNewRecord) :?>active<?php endif;?>" data-toggle="tooltip" title="Choose your Shipping method.">Customer</button>
									 </div>
									 <div class="btn-group" role="group">
										<button type="button" data-switch-set="shippingdetail" data-switch-value="2" class="btn btn-primary" data-toggle="tooltip" title="Load Customer Secondary Shipping method.">Other</button>	
									 </div>
								</div>
								<div class="" id="shipping-detail-form-content" style="margin-top:5px">
									...
									<div class="form-group" id="shippingcompany-group">
										<select class="form-control" id="shippingcompany" name="shippingcompany" disabled>
										...
										<div class="row">
											...
											<div class="col-sm-9 desc-group"> 
												<div class="input-group">													  
													...
													<input class="typeahead form-control input_fn" type="text" style="border-radius:0;" name="description[]" id="autocompleteitem_1" placeholder="Select an Item" data-provide="typeahead" autocomplete="off" disabled>
													...
													<span class="input-group-btn">
														<button class="btn btn-success input_sr" id="showRequestItem_1" style="border-radius: 0 4px 4px 0" data-toggle="tooltip" title="Having trouble finding your item? Request help." type="button" >+</button>
