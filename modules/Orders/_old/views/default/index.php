...
$this->title = (Yii::$app->user->identity->usertype!==User::REPRESENTATIVE && Yii::$app->user->identity->usertype!==User::TYPE_CUSTOMER) ? 'Sales Orders' : 'Orders';
                                ...
                                <!-- main gridview -->
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs" id="order-main-gridview">
                                        ...
                                        <ul id="myTab" class="nav nav-tabs bar_tabs right hide-mobile" role="tablist">
											...
											<?php endif;?>
                                            <li role="presentation" class="active col-sx-3"><a href="#orderhome" onClick="loadOrders('all', '', <?=$customer;?>);" id="order-tab-1" role="tab" data-toggle="tab" aria-expanded="true">All</a>
                                            </li>
                                            <?php if(Yii::$app->user->identity->usertype!==User::REPRESENTATIVE && Yii::$app->user->identity->usertype!==User::TYPE_CUSTOMER) :?>
