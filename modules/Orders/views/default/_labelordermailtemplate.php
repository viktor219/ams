                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="content-cell" style="padding: 35px;padding-top: 10px;">
                                                        <h1 style="margin-top: 0;color: #2F3133;font-size: 19px;font-weight: bold;text-align: left;">Hello,</h1>
                                                        ...
                                                        <table class="body-action" align="center" width="100%" cellpadding="0" cellspacing="0" style="width: 100%;padding: 0;text-align: center;">
                                                            <tbody><tr>
                                                                    <td align="center">
                                                                        <div>
                                                                        	<img width="570" src="<?= Url::base(true); ?>/public/medias/labels/<?=$_shipment->master_trackingnumber?>.png">
