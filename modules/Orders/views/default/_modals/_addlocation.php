			...
			<div class="modal-body">
				...
				<div class="row">
					<div class="col-sm-6">
						...
						<input type="text" class="form-control" id="storename" placeholder="Location Name (Optional)">
					</div>
					<div class="col-sm-6">
						<label class="sr-only" for="storenum"></label>
						<input type="text" class="form-control" id="storenum" placeholder="Location Number (Optional)">				
					</div>
				</div>
				<br/>
				<div class="row">
