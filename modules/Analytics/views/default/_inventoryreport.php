            ...
            <div class="x_content">
                <?php foreach ($categories as $category): ?>
                    <div class="row" style="padding: 2px; padding-left: 10px; font-size: 14px; background: #73879C; color: #FFF; border-radius:5px; margin-bottom: 10px;">
                        ...
                        <div class="col-md-7 vcenter text-right col-xs-2" style="margin-top:3px;"> 
                            <button class="btn btn-xs btn-info glyphicon glyphicon-plus" id="load-models-category-<?= $category->id; ?>" cid="<?= $category->id; ?>" pid="<?= $customer->id; ?>" style="display: none;"></button>
                            <button class="btn btn-xs btn-info glyphicon glyphicon-minus" id="close-models-category-<?= $category->id; ?>" cid="<?= $category->id; ?>" ></button>
                        </div>
                    </div>
                    <div id="loaded-content-category-<?php echo $category->id; ?>">
