  ...
  <div class="modal-dialog" role="document">
	<div class="modal-content">
		...
		<div class="modal-body">
			<div class="row row-margin">
				<b>Add Or Edit Options:</b>
			</div>
			<div id="configurations-options-manager">
				<div class="model-option-form">
					<?php $form = ActiveForm::begin(['action'=>Yii::$app->request->baseUrl . '/modeloption/createoption', 'options' => ['id'=>'add-option-form']]); ?>
			...
			<!-- <h2>Add title</h2>
			<form class="form-group" id="add-option-form-one" >
				<div class="row-margin"  id="option-title-group">
						<span class="input-group-btn">
							<button type="button" class="btn btn-success" id="addConfigTitleBtn"><span class="glyphicon glyphicon-plus"></span></button>
						</span>
						<input type="text" id="titleConfig" class="form-control" placeholder="Title (required)">
					</div>
				</div>
			</form>
			<h2>Add Sub title</h2>
			<form class="form-group" id="add-option-form-two" >
				<div class="row row-margin" id="autocomplete-parentoption-group">
					<input type="text" id="autocomplete-parentoption" class="form-control" name="customer" placeholder="select Title (Required)" autocomplete="off">
					<input type="hidden" id="parentoptionID" name="parentoptionId" />
				</div>
				<div class="row row-margin">
					<div class="input-group">
						<span class="input-group-btn">
							<button type="button" class="btn btn-success" id="addConfigOptionBtn"><span class="glyphicon glyphicon-plus"></span></button>
						</span>
						<input type="text" id="optionName" class="form-control" placeholder="Sub title (required)">
					</div>
				</div>
			</form>
			<h2>Add new option</h2>
			<form class="form-group" id="add-option-form-one" >
				<div class="row-margin" id="autocomplete-parentoption-group">
					<input type="text" id="autocomplete-parentoption" class="form-control" name="customer" placeholder="select Title (Required)" autocomplete="off">
					<input type="hidden" id="parentoptionID" name="parentoptionId" />
				</div>
				<div class="row row-margin">
					<div class="input-group">
						...
						<input type="text" id="optionName" class="form-control" placeholder="Option name (required)">
					</div>
				</div>
				<div class="row-margin">
					<div class="input-group">
						<div class="checkbox">
							<label class="">
								<input id="inp_config_option" type="checkbox" hidden/>
							</label>
						</div>	
					</div>
				</div>
		...
		<div class="modal-footer">
			<button type="button" class="btn btn-primary" data-dismiss="modal" >Close</button>
			<button type="button" class="btn btn-success" onClick="saveConfigurations();" >Save</button>
		</div>
  </div>
</div>
</div>
