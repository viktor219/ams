						...
						<div id="searchinventory-group" class="pull-right top_search">
							<div class="input-group <?php echo (Yii::$app->user->identity->usertype==User::REPRESENTATIVE || Yii::$app->user->identity->usertype===User::TYPE_CUSTOMER)?"search-representative":"";?>">
								...
								<span class="input-group-btn navigate-buttons">
									<?= Html::a('<span class="glyphicon glyphicon-plus"></span> New Model', ['create'], ['class' => 'btn btn-success', 'style' => 'margin-left: 5px;border-radius:4px;']) ?>
									<?= Html::a('<span class="glyphicon glyphicon-plus"></span> New Assembly', ['/assembly/create'], ['class' => 'btn btn-success', 'style' => 'margin-left: 1px;border-radius:4px;']) ?>								
								</span>
                                                                <?php endif; ?>
							</div>						
						</div>
