...
<?= $this->render("_modals/_transferconfirmation", ["order"=>array()]);?>
<?php 
													...
													<div class="row form-group">
														...
														<div class="form-group col-sm-8 r_model-group">
															<div class="input-group">
																...
																<span class="input-group-btn">
																	<button class="btn btn-danger removeAutoCompleteButton" id="removeAutoCompleteId_1" type="button" disabled><span class="glyphicon glyphicon-remove"></span></button>
																</span>
																<!--<span class="input-group-btn">
