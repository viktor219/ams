...
$divisions = ArrayHelper::map(\app\models\LocationParent::find()->all(), 'id', 'parent_name');
?>
<style>
	.form-control{border-radius: 5px}
        #user_type_group, #user-customer-group, #upload-group{
            margin-top: 10px;
        }
</style>
				...
				<div class="" role="tabpanel" data-example-id="togglable-tabs">
					<div id="myTabContent" class="tab-content">	
					    ...
					    <div class="row">
							...
							<div class="col-md-6">
								<?= Html::dropDownList('u_division_id', $user->division_id, $divisions, ['prompt' => '-Please Choose Division-', 'class' => 'form-control']); ?>
							</div>                                                
					    ...
					    <div class="row" id="veryDepartment" <?php if(!isset($user->usertype)){?> style="display: none; <?php } ?>  <?php if(isset($user->usertype) && $user->usertype != 3){?> style="display: none;<?php } ?>">
					        <div id="location_email-group" class="col-sm-6"></div>
					        <div class="col-sm-6">
