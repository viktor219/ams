...
class DefaultController extends Controller {
	...
	*/
    ...
    /**
     *  This function is one that create new users.
     * @return type
     * @throws NotFoundHttpException
     */
    public function actionCreate() {
        ...
        if(empty($_post)){
            ...
            if(User::findByUsername($_post['u_username'])) {
                $_message = "The same username is already exist.";
                Yii::$app->getSession()->setFlash('danger', $_message);
            } else {
                ...
                $model->division_id = $_post['u_division_id'];
                ...
                if ($model->save()) {
                    ...
                    if( $model->usertype == 1 || $model->usertype == 9 ) {
