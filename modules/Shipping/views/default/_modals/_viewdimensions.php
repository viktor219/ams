  ...
  <div class="modal-dialog" role="document">
	<div class="modal-content">
	  <div class="modal-header">
		...
		<h4 class="modal-title" id="myModalLabel"> <span class="glyphicon glyphicon-list-alt"></span> <span id="box-actions"></span> Weight & Dimensions : <span id="dim_box_model_name"></span></h4>
	  </div>
