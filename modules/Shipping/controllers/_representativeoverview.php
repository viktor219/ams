...
<?= $this->render("modals/_savelocation");?>
<?= $this->render("@app/modules/Location/views/default/_modals/_addlocationdetails");?>
...
<?php if(Yii::$app->session->hasFlash('warehouse_id')) :?>
	OpenRelatedServiceModal(<?= Yii::$app->session->getFlash('warehouse_id');?>);
<?php endif;?>
</script>
				...
				<div class="x_content" style="padding:0;margin-top:0;">
					...
					<div class="" role="tabpanel" data-example-id="togglable-tabs">
						<div id="myTabContent" class="tab-content">	
									  ...
									  <div class="form-group">
										<div class="input-group" style="margin-bottom: 5px;"> 
											<span class="input-group-btn">
												<button type="button" class="btn btn-success btn-md locationField" onClick="loadCustomerLocation('',<?php echo $customer->id;?>)"><span class="glyphicon glyphicon-plus"></span></button>
											</span>
							...
							<div class="row" style="display:none;" id="rma-location-items-box">
								<div class="panel panel-primary">
								  <div class="panel-heading">
							...
							<div class="row" style="display:none;" id="rma-location-add-items-box">
								<div class="panel panel-primary">
								  <div class="panel-heading">
									<h3 class="panel-title">Reallocate An Item</h3>
								  </div>
								  <div class="panel-body">
							...
							<div class="row row-margin">
								<div class="col-md-12 text-right rmaform-actions">			
									<label for="allowdirectshippingreq" class="checkbox-inline" style="font-weight:bold;">Send Advance Exchanges for this RMA?</label>																	
											...
											<div class="x_content">
												<div class="" role="tabpanel" data-example-id="togglable-tabs" id="rma-main-gridview">
													<ul id="myTab" class="nav nav-tabs bar_tabs right  hide-mobile" role="tablist">
														...
														<li role="presentation" class="" style="display:none;" id="search-serial-overview-title"><a href="#rmacustomerinventorysearch" id="rma-overview-tab-1" role="tab" data-toggle="tab" aria-expanded="true">Search(<span class="serial-search-count"></span>)</a>
 														</li>                                                                                                                                                                                                                                                               
													</ul>
													<div id="myTabContent" class="tab-content">   
														<div id="loading-inventory" style="background : transparent;position: relative;top:0;left:50%;z-index:100000;"><img src="<?php echo Yii::$app->request->baseUrl;?>/public/images/ellipsis.gif" style="max-width:80px;max-width:40px;"/></div>													
														<div role="tabpanel" class="tab-pane fade active in" id="rmacustomerinventoryhome" aria-labelledby="rmacustomerinventoryhome-tab">
															<div id="loaded-content-inventory-category"></div>
															<?php //= $this->render('_stockoverview', ['customer'=>$customer, 'categories'=>$categories, '_location'=>$_location]) ?>
														</div>
														<div role="tabpanel" class="tab-pane fade in" id="rmacustomerinventorydivision" aria-labelledby="rmacustomerinventorydivision-tab">
															<div id="loaded-content-inventory-location"></div>
															<?php //= $this->render('_locationstockoverview', ['customer'=>$customer, 'locations'=>$_inventorylocations, '_location'=>$_location]) ?>
														</div>
