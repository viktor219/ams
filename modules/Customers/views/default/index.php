...
<?= $this->render("@app/views/layouts/_modals/_deleteconfirm", ['page' => 'Customer']); ?>
...
//			            ]);
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs" id="customer-main-gridview">
                        <ul id="myTab" class="nav nav-tabs bar_tabs right hide-mobile" role="tablist">
                            <li role="presentation" class="active"><a href="#customerall" onClick="loadCustomers('');" id="order-tab-0" role="tab" data-toggle="tab" aria-expanded="true">All</a>
                            </li>
                            <li role="presentation" class="left" id="customer-deleted-tab"><a href="#customerdelete" onClick="deleteCustomers('');" id="order-tab-6" role="tab" data-toggle="tab" aria-expanded="true">Deleted (<span class="total_delete_count"><?= $basket_count; ?></span>)</a>
	                    </li>
                        </ul>
                        <div id="myTabContent" class="tab-content">    
                            <div role="tabpanel" class="tab-pane fade active in" id="customerall" aria-labelledby="home-tab">                 
                                <div id="main-gridview"></div>
                            </div>
                            <div role="tabpanel" class="tab-pane fade" id="customerdelete" aria-labelledby="home-tab">                 
                                <div id="customer-deleted-content"></div>
                            </div>
                        </div>
                    </div>
                 			...
                 			<div class="x_panel">
                                ...
                                <!-- 
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs" id="customer-search-gridview" style="display:none;">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs right" role="tablist">
                                            <li role="presentation" class="active"><a href="#customersearch" id="order-tab-0" role="tab" data-toggle="tab" aria-expanded="true">Search Results (<span class="customer-results-count"><b>0</b></span>) </a>
                                            </li>                                                              
                                        </ul>
