           ...
           // ['class' => 'yii\grid\SerialColumn'],
            ['attribute' => 'customer_id	',
                ...
                'value' => function($model) {
                    return Customer::findOne($model->customer_id)->companyname;
                }
            ],
            ['attribute' => 'storenum',
                ...
                'buttons' => [
                    'view' => function ($url, $model, $key) {
                        return Html::a('', 'javascript://', ['title' => Yii::t('app', 'View Location'),
                                    'class' => 'glyphicon glyphicon-eye-open btn btn-info viewLocation','lid'=>$model->id]);
                    },
                            'update' => function ($url, $model, $key) {
                        return Html::a('', 'javascript://', ['title' => Yii::t('app', 'Manage Location'),
                                    'class' => 'glyphicon glyphicon-edit btn btn-warning updateLocation','lid'=>$model->id]);
                    },
                            'delete' => function ($url, $model, $key) {
                        
                        return Html::a('', "javascript://", ['title' => Yii::t('app', 'Delete Location'),
                                    'class' => 'glyphicon glyphicon-trash btn btn-danger deleteLocation','cid'=>$_GET["customer"],'lid'=>$model->id]);
