  ...
  <div class="modal-dialog" role="document">
	<div class="modal-content">
	  <div class="modal-header">
		...
		<form class="form-group form-group-sm" id="l-add-location-form" >	
							...
							<div class="form-group" id="ldeliverymethod-group">
								<select class="shipping_method_select2_single form-control" id="lshippingmethod" name="lshippingmethod">
									...
									<?php foreach(ShipmentMethod::findAll(['shipping_company_id'=>$_shipping_method->shipping_company_id]) as $shipmethod) :?>
										...
										?>
										<option value="<?php echo $shipmethod->id;?>" <?php echo ($_shipment->shipping_deliverymethod===$shipmethod->id) ? 'selected' : '';?>><?php echo $__shipping_method;?></option>
									<?php endforeach;?>
								</select>								
							</div>					
					</div>				
