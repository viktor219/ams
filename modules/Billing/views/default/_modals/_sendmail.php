  ...
  <div class="modal-dialog" role="document">
	<div class="modal-content">
	  <div class="modal-header">
		...
		<h4 class="modal-title" id="myModalLabel"> <span class="glyphicon glyphicon-list-alt"></span> Send Email With Invoice Attached</h4>
	  </div>
		<div class="alert alert-success fade in" id="sendemail-msg" style="display:none;"></div>
			<?php $form = ActiveForm::begin(['action'=>['/billing/sendmail'], 'options' => ['id'=>'send-mail-form']]); ?>
