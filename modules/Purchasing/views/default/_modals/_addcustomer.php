	...
	<div class="col-md-12 col-sm-6 col-xs-12">
		<div class="x_panel">
		  ...
		  <div class="modal-body">
				...
				<div class="row row-margin">
					<div class="col-md-3 col-sm-6 col-xs-12 form-group" id="defaultaccountnumber-group">
						<input type="text" class="form-control" id="defaultaccountnumber" placeholder="Default Account Number (Required)">
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 form-group" id="defaultshippingmethod-group">
						<input type="text" class="form-control" id="defaultshippingmethod" placeholder="Default Shipping method (Required)">
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 form-group" id="secondaryshippingmethod-group">
						<input type="text" class="form-control" id="secondaryshippingmethod" placeholder="Secondary Shipping method (Optionnal)">
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 form-group" id="secondaryaccountnumber-group">
