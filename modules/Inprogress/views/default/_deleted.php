					...
					[
						...
						'buttons' => [
							'revert' => function ($url, $model, $key) {
								...
								$url = \yii\helpers\Url::toRoute(['/inprogress/revert', 'id'=>$model->id, 'customer' => (Yii::$app->user->identity->usertype===User::REPRESENTATIVE)?Yii::$app->user->id:0]);
							...
							'delete' => function ($url, $model, $key) {
								...
								$url = \yii\helpers\Url::toRoute(['/inprogress/rdelete', 'id'=>$model->id]);
