...
<html lang="en">
		...
		<div class="container body">
			<div class="main_container">
				...
				<div class="right_col" role="main">
					...
					<footer>
						<div class="">
							<p class="pull-right">Asset Management System |
    ...
    <script type="text/javascript" src="<?php echo Yii::$app->request->baseUrl;?>/public/js/notify/pnotify.nonblock.js"></script>
