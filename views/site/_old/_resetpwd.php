                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="content-cell" style="padding: 35px;padding-top: 10px;">
                                                        ...
                                                        <p style=" margin-top: 0;color: #74787E;font-size: 16px;line-height: 1.5em;text-align: left;">You recently requested to reset your password for your <?= Yii::$app->name; ?> account. Click the button below to reset it.</p>
                                                        <!-- Action -->
                                                            ...
                                                            <tbody><tr>
                                                                    <td align="center">
                                                                        <div>
                                                                            ...
                                                                            <a href="<?= Url::base(true) . '/site/resetpwd?token=' . $model->token; ?>" class="button button--red" style="background-color: #ec867b;display: inline-block;width: 200px;border-radius: 3px;color: #ffffff;font-size: 15px;line-height: 45px;text-align: center;text-decoration: none;-webkit-text-size-adjust: none;mso-hide: all;">Reset your password</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </tbody></table>
                                                        <p style=" margin-top: 0;color: #74787E;font-size: 16px;line-height: 1.5em;text-align: left;">If you did not request a password reset, please ignore this email or reply to let us know.</p>
                                                        <p style=" margin-top: 0;color: #74787E;font-size: 16px;line-height: 1.5em;text-align: left;">Thanks,<br><?= Yii::$app->name; ?> Team</p>
                                                        <p style=" margin-top: 0;color: #74787E;font-size: 16px;line-height: 1.5em;text-align: left;"><strong>P.S.</strong> We also love hearing from you and helping you with any issues you have. Please reply to this email if you face any trouble in resetting your password.</p>
                                                        <!-- Sub copy -->
                                                        <table class="body-sub" style="margin-top: 25px;padding-top: 25px;border-top: 1px solid #EDEFF2;">
                                                            <tbody><tr>
                                                                    <td>
                                                                        <p class="sub" style="font-size: 12px;margin-top: 0;color: #74787E;line-height: 1.5em;text-align: left;">If you're having trouble clicking the password reset button, copy and paste the URL below into your web browser.</p>
                                                                        <p class="sub" style="font-size: 12px;margin-top: 0;color: #74787E;line-height: 1.5em;text-align: left;"><a style="color: #3869D4;" href="<?= Url::base(true) . '/site/resetpwd?token=' . $model->token; ?>"><?= Url::base(true) . '/site/resetpwd?token=' . $model->token; ?></a></p>
                                                                    </td>
                                                                </tr>
                                                            </tbody></table>
                                                    </td>
