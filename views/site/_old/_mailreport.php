                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="content-cell" style="padding: 35px;padding-top: 10px;">
                                                        ...
                                                        <p style=" margin-top: 0;color: #74787E;font-size: 16px;line-height: 1.5em;text-align: left;">You have subscribed to <?= strtolower($reportOption); ?> emails for "<?= $fileName; ?>" in your <?= Yii::$app->name; ?>. Download your report by clicking on the button below.</p>
                                                        <!-- Action -->
                                                            ...
                                                            <tbody><tr>
                                                                    <td align="center">
                                                                        <div>
                                                                            ...
                                                                            <a href="<?= $downloadFileLink; ?>" class="button button--red" style="background-color: #4cae4c;display: inline-block;width: 200px;border-radius: 3px;color: #ffffff;font-size: 15px;line-height: 45px;text-align: center;text-decoration: none;-webkit-text-size-adjust: none;mso-hide: all;">Download Report</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </tbody></table>
