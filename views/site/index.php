...
?>
<?= $this->render("modals/_serials");?>
<?= $this->render("modals/_picklistready");?>
<style>
	.count_top
	{
		text-align:center;
			...
			<div class="dashboard_graph">
				<div class="row x_title">
					<div class="col-md-6">
                                            ...
                                            <div class="col-md-6 shipping-reciving-label">
                                                <div>
					...
					<div class="x_panel">
						<div class="x_title">
							...
							<ul class="nav navbar-right panel_toolbox">
								...
								<li class="dropdown">
									<a href="#" class="dropdown-toggle" id="refresh-awaiting-delivery" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-refresh"></i></a>
								</li>
								<li><a class="close-link"><i class="fa fa-close"></i></a>
								</li>
							</ul>
